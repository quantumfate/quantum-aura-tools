...
function QAT.Settings_Register()
    ...
    local optionsData = {
        ...
        },
        {
            ...
            getFunc = function() return account.enabled end,
            setFunc = function(v) account.enabled = v end,
        ...
        },
        {
            ...
            getFunc = function() return account.backgroundCapture end,
            setFunc = function(v) account.backgroundCapture = v end,
